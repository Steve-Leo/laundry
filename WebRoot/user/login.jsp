            ...
            <div class="col-xs-5">
				...
				action="user/login.action">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="account" placeholder="用户名" name="account">
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div>
                    <div class="col-sm-offset-5 col-sm-4">
                        <a href="user/register.jsp" class="text-center">
                          免费注册
                        </a>
                    </div>
                    <div class="col-sm-3">
                        <a href="user/forget_pass.jsp" class="text-center">
                            忘记密码
                        </a>
                    </div>
                </div>
