...
<script src="script/recharge_result.js"></script>
</head>
		...
		<div class="order_block">
			...
			<div class="head_block">
				<div class="info_block">
					<p class="title">
						您已成功充值&nbsp;<strong id="total"><%=r3_Amt%></strong>&nbsp;元
					</p>
					<p class="account_info">您之后可使用账户余额进行消费。请牢记您的站内支付密码。</p>
					<div class="address_info">
						易付宝订单号&nbsp;：<a id="ordernum"><%=r6_Order%></a> <br>易宝支付交易流水号&nbsp;：<a><%=r2_TrxId%></a>
					</div>
			...
			<div class="head_block2">
				<div class="info_block">
					<p class="title2">充值失败</p>
					<p class="account_info">请检查您的支付信息是否正确！</p>
					<div class="address_info">
						易付宝订单号&nbsp;：<a id="ordernum"><%=r6_Order%></a> <br>易宝支付交易流水号&nbsp;：<a><%=r2_TrxId%></a>
					</div>
			...
			<div class="pay_block">
				<div class="box">
					<p>您可以选择重新支付或&nbsp;<a href="user/toUserCenter.action">点击此处</a>&nbsp;返回用户中心。</p>
				</div>
			</div>
			<%
				}
...
<form id="shit" action="user/toUserCenter.action" method="post">
</form>
</body>
</html>
